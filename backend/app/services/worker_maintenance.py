    ...
    return _bash(
        "\n".join(
            [
                ...
                "",
                "def choose_port():",
                "    # This auto-created inbound uses plain VLESS, not TLS. Port 443 may accept",
                "    # TCP connections while dropping non-TLS payload before it reaches Xray.",
                "    for port in (8443, 30000, 30001, 30002):",
