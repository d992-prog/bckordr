...
MIGRATIONS = (
    ...
    "ALTER TABLE worker_nodes ADD COLUMN IF NOT EXISTS vpn_inbound_port INTEGER NULL",
    "ALTER TABLE worker_nodes ADD COLUMN IF NOT EXISTS vpn_inbound_protocol VARCHAR(32) NULL",
    "ALTER TABLE worker_nodes ADD COLUMN IF NOT EXISTS vpn_inbound_transport VARCHAR(32) NULL",
    "ALTER TABLE worker_nodes ADD COLUMN IF NOT EXISTS vpn_inbound_security VARCHAR(32) NULL",
