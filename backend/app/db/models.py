...
class ZoneRule(Base):
    ...
    second: Mapped[int] = mapped_column(Integer, default=30, server_default="30")
    ...
    window_duration_seconds: Mapped[int] = mapped_column(Integer, default=95, server_default="95")
...
class WorkerNode(Base):
    ...
    vpn_inbound_port: Mapped[int | None] = mapped_column(Integer, nullable=True)
    vpn_inbound_protocol: Mapped[str | None] = mapped_column(String(32), nullable=True)
    vpn_inbound_transport: Mapped[str | None] = mapped_column(String(32), nullable=True)
    vpn_inbound_security: Mapped[str | None] = mapped_column(String(32), nullable=True)
    vpn_listener_status: Mapped[str | None] = mapped_column(String(32), nullable=True)
...
class DropDomain(Base):
    ...
    window_start_second: Mapped[int] = mapped_column(Integer, default=30, server_default="30")
    window_duration_seconds: Mapped[int] = mapped_column(Integer, default=95, server_default="95")
    notes: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class DiscoveryDomain(Base):
    ...
    is_enabled: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")
    check_interval_seconds: Mapped[int] = mapped_column(Integer, default=10, server_default="10")
    ...
    last_status_signature: Mapped[str | None] = mapped_column(Text, nullable=True)
    last_owner_signature: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class DiscoveryObservation(Base):
    ...
    registrar_name: Mapped[str | None] = mapped_column(Text, nullable=True)
    owner_handle: Mapped[str | None] = mapped_column(Text, nullable=True)
    name_servers: Mapped[str | None] = mapped_column(Text, nullable=True)
    status_signature: Mapped[str | None] = mapped_column(Text, nullable=True)
    owner_signature: Mapped[str | None] = mapped_column(Text, nullable=True)
    change_detected: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
