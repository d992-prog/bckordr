...
from app.api.routes.vpn_portal import router as vpn_portal_router
...
api_router.include_router(vpn_telegram_router)
api_router.include_router(vpn_portal_router)
